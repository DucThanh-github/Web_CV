<template>
    <div class="grid grid-cols-1 md:gap-20 md:grid-cols-2">
      <div>
        <img
          class="max-w-xs w-full rotate-3 rounded-3xl block md:hidden mb-8"
          src="https://spotlight.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fportrait.79754e9e.jpg&w=640&q=75"
          alt=""
        />
        <h1 class="text-5xl font-bold mb-8 dark:text-dark-title-color">
          I’m Spencer Sharp. I live in New York City, where I design the future.
        </h1>
  
        <div class="space-y-7 text-p-style text-p-color">
          <p>
      ...
      <div>
        <img
          class="w-full rotate-3 rounded-3xl hidden md:block"
          src="https://spotlight.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fportrait.79754e9e.jpg&w=640&q=75"
          alt=""
        />
        ...
        <ul class="max-w-fit text-p-color text-p-style space-y-4 my-8">
          <li class="group hover:text-green-500">
            <a href="https://twitter.com/" class="flex items-center"
              ...
              <span class="pl-12"> Follow on Twitter </span>
            </a>
          </li>
          <li class="group hover:text-green-500">
            <a href="https://www.instagram.com/" class="flex items-center"
              ...
              <span class="pl-12"> Follow on Instagram </span>
            </a>
          </li>
          <li class="group hover:text-green-500">
            <a href="https://github.com/" class="flex items-center "
              ...
              <span class="pl-12"> Follow on GitHub </span>
            </a>
          </li>
          <li class="group hover:text-green-500">
            <a href="https://www.linkedin.com/" class="flex items-center "
              ...
              <span class="pl-12"> Follow on LinkedIn </span>
            </a>
          </li>
        ...
        <div class="border-t border-gray-200 pt-8 dark:border-gray-700 dark:text-dark-title-color group hover:text-green-500">
            ...
            <span class="px-12"> spencer@planetaria.tech </span>
          </a>
        </div>
      </div>
    </div>
